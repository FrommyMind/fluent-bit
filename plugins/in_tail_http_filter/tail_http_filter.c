...
static struct flb_config_map config_map[] = {
    ...
    /*
     * in_tail options - these MUST use FLB_TRUE with offsets relative to
     * flb_tail_config, because flb_tail_config_create() calls
     * flb_input_config_map_set(ins, tail_config) internally.
     */
